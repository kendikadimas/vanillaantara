      ...
      <section id="kontak" className="relative bg-forest engraving-bg py-28 lg:py-40 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-12">
          ...
          <FadeUp delay={0.1} className="text-center mb-6">
            <h2 className="font-serif text-5xl lg:text-7xl text-cream leading-[1.05] tracking-[-0.01em]">
              Source Premium<br />
          ...
          <FadeUp delay={0.2} className="text-center mb-14">
            <p className="font-sans text-base text-cream/55 leading-relaxed max-w-lg mx-auto">
          ...
          {/* CTAs */}
          <FadeUp delay={0.3} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              href={WA_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-9 py-4 bg-gold text-forest font-sans text-sm font-medium tracking-[0.1em] uppercase hover:bg-gold-light transition-all duration-300 w-full sm:w-auto justify-center"
            >
            ...
            <a
              href="mailto:info@vanillaantara.com"
              className="inline-flex items-center gap-3 px-9 py-4 border border-cream/25 text-cream font-sans text-sm tracking-[0.1em] uppercase hover:border-cream/60 hover:text-cream transition-all duration-300 w-full sm:w-auto justify-center"
            >
              Email Us
            </a>
          </FadeUp>
          ...
          {/* Trust bar */}
          <FadeUp delay={0.4}>
            <div className="border-t border-gold/15 pt-10 grid grid-cols-3 gap-6 text-center max-w-xl mx-auto">
              {[
