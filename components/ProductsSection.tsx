...
const products = [
  ...
  },
  {
    ...
    grade: "Food Grade · Export Ready",
    desc: "Ground from whole cured Planifolia pods — no fillers, no carriers, no artificial flavour. Consistent vanillin concentration for fast-turn production.",
    image: "/images/product-export-batch.jpg",
    alt: "Pure vanilla powder in packaging",
    zoom: "scale-125",
    specs: [
      { label: "Base", val: "100% Planifolia" },
      { label: "Form", val: "Fine Powder" },
      { label: "Docs", val: "CoA & Phyto" },
      { label: "MOQ", val: "500g sample" },
    ],
  },
];
